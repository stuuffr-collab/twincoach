`contract_sc04_answer_submit_and_feedback_v1_1`
...
- Week 1 feedback behavior:
  ...
  - `needs_review` = answer accepted as incorrect and learner should review the core idea
  - `try_fix` = answer accepted as incorrect and learner should check the setup again
  - `needs_another_check` = answer accepted as incorrect and evidence remains limited
...
- Successful submit
  ...
  - `sessionItemId` matches current session item
